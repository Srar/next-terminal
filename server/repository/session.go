...
func (r SessionRepository) GetOnlineSessionsByUserID(userID string) (o []model.Session, err error) {
	err = r.DB.Where("status in ? and creator = ?", []string{constant.Connecting, constant.Connected}, userID).Find(&o).Error
	return
}
